...
namespace ESHOPPER.Controllers.Admin
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Dashboard()
        {
            ...
            {
                // 1. SẢN PHẨM HOẠT ĐỘNG (Gọi SQL Function)
                ProductCount = db.Database
                             .SqlQuery<int>("SELECT dbo.fn_GetActiveProductCount()")
                             .FirstOrDefault(),
                CustomerCount = db.Database
                             .SqlQuery<int>("SELECT dbo.fn_GetTotalCustomerCount()")
                             .FirstOrDefault(),
                // 2. TỔNG SỐ ĐƠN HÀNG
